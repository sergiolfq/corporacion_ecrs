<?php  
//error_reporting(-1);
//echo dirname(__FILE__)."\..\includes\includes.php";
//echo dirname(__FILE__)."\services\\fiscalizar.back.php";
//require_once(dirname(__FILE__)."\..\includes\includes.php"); require_once(dirname(__FILE__)."\services\\fiscalizar.back.php");
//error_reporting(-1);
//require_once("../includes/includes.php"); 
include("services/fiscalizar.back.php"); 
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        * html #poplala {position:absolute;}
        ...
        <link rel="stylesheet" href="modules/controls/SlickGrid/slick.grid.css" type="text/css"/>
        <link rel="stylesheet" href="modules/controls/SlickGrid/css/smoothness/jquery-ui-1.8.16.custom.css" type="text/css"/>
        <link rel="stylesheet" href="modules/controls/SlickGrid/controls/slick.pager.css" type="text/css"/>
        <link rel="stylesheet" href="modules/controls/SlickGrid/examples/enajenaciones.css" type="text/css"/>  
    ...
    <body style="background: white;" onload="onLoad();">
                    ...
                    <tr>
                        <td>
                            <table class="TablaNormal" border="0" cellspacing="0" cellpadding="0" width="97%" align="left" id="Table1" style="z-index:102; text-align:left">
                                <tr>
                                    <td>
                                        <?php //include("controls/access.inc"); ?>         <!--  mensaje que aparecia arriba -->                                                                                         
                                    </td>
                                </tr>
                            </table>                            
                            <p>&nbsp;</p>
                        ...
                        <th class="productos_round_box">                            
                            <table class="TablaNormal" border="0" cellspacing="1" cellpadding="0" width="97%" align="left" id="Table1" style="z-index:102; text-align:left">
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#F4F4F4"><input required="true" id="Numero_registro_maquina" name="Numero_registro_maquina" type="text" size="21" maxlength="40" style="text-transform:uppercase" class="TextoCajaNormal" required="true" tabindex="8" value="<?php echo $serial_maquina; ?>"/>
        ...
        <script src="modules/javascript/fiscalizar/jquery-1.7.1.min.js" type="text/javascript"></script>        
        <script src="modules/javascript/fiscalizar/jquery.maskedinput-1.3.min.js" type="text/javascript"></script>
        <script src="modules/javascript/fiscalizar/jquery.validate.min.js" type="text/javascript"></script>
        <script src="modules/javascript/fiscalizar/datepicker-2.5.js" type="text/javascript"></script>   
        
        <script src="modules/controls/SlickGrid/lib/jquery.event.drag-2.0.min.js"></script>
        <script src="modules/controls/SlickGrid/slick.core.js"></script>
        <script src="modules/controls/SlickGrid/slick.grid.js"></script>  
                    
        <script src="modules/controls/SlickGrid/plugins/slick.checkboxselectcolumn.js"></script>
        <script src="modules/controls/SlickGrid/plugins/slick.autotooltips.js"></script>
        <script src="modules/controls/SlickGrid/plugins/slick.cellrangedecorator.js"></script>
        <script src="modules/controls/SlickGrid/plugins/slick.cellrangeselector.js"></script>
        <script src="modules/controls/SlickGrid/plugins/slick.cellcopymanager.js"></script>
        <script src="modules/controls/SlickGrid/plugins/slick.cellselectionmodel.js"></script>
        <script src="modules/controls/SlickGrid/plugins/slick.rowmovemanager.js"></script>
        <script src="modules/controls/SlickGrid/plugins/slick.rowselectionmodel.js"></script>
        <script src="modules/controls/SlickGrid/slick.formatters.js"></script>
        <script src="modules/controls/SlickGrid/slick.editors.js"></script>
