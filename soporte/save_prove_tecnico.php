...
<table class='table table-condensed' width="1000" style="font-family : Arial; font-size : 9pt"><br>
...
while($usuario=mysql_fetch_array($result,MYSQL_ASSOC)){
                ...
                <tr>
                  ...
                  <td>
                      <a title="Modificar" id="editar_da" href="enajenar_prove_tecnico.php?id=<?php echo $usuario["id"] ?>&Ope=Editar"><img src="images/edit.png" width="20" height="20"></a>&nbsp; 
                      <a title="Eliminar" id="eliminar_da" href="save_prove_tecnico.php?id=<?php echo $usuario["id"] ?>&Ope=Eliminar"><img src="images/delete.png" width="20" height="20"></a>
                  </td>
                </tr>
                <?php } ?>
