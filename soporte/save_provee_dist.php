...
if($editar_datos == ''){
    ...
    $sql = "INSERT INTO q_enajenacion (hora_registro,ciudad_contribuyente,estado_contribuyente,id_cliente,id_estatus_enajenacion,id_producto,numero_control,numero_factura,id_usuario,id_proveedor,tipo_cliente,id_distribuidor,mes_enajenar,anio_enajenar,razon_contribuyente,contacto_contribuyente,direccion_contribuyente,
        ...
        VALUES ('".$hora_registro."','".$ciudad_contrib."','".$estado_contrib."','".$id_cliente."','".$id_estatus_enajenacion."','".$producto."','".$numero_control."','".$numero_factura."','".$id_usuario."','".$id_proveedor."','".$tipo_cliente."','".$id_distribuidor."','".$mes_enajenar."','".$anio_enajenar."','".$razon_contrib."','".$contacto_contrib."','".$direccion_contrib."',
...
while($usuario=mysql_fetch_array($result,MYSQL_ASSOC)){
                ...
                <tr>
                  ...
                  <td>
                      <a title="Modificar" id="editar_da" href="enajenar_provee_dist.php?id=<?php echo $usuario["id"] ?>&Ope=Editar"><img src="images/edit.png" width="20" height="20"></a>&nbsp; 
                      <a title="Eliminar" id="eliminar_da" href="save_provee_dist.php?id=<?php echo $usuario["id"] ?>&Ope=Eliminar"><img src="images/delete.png" width="20" height="20"></a>
                  </td>
                </tr>
                <?php } ?>
...
<center>         
        <div class="form-inline">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button type="submit" class="btnn-default" onclick="location.href='enajenar_provee_dist.php'">Continuar Enajenando</button>
        </div>
    <br>
</center> 
