    ...
    <div>
        ...
        <div id="muestra">
            ...
            ?>
                    ...
                    <table width="625" height="100" border="0" style="font-family : Eras Medium ITC; font-size : 12pt;">   

                        <tr><td>
                                Nota: Durante el periodo correspondiente al mes de <?php echo $mes_vacio;?> de <?php echo $anio_vacio;?>, no se realizaron Enajenaciones de Máquinas Fiscales.
                            </td>
                        </tr>
                    </table>
